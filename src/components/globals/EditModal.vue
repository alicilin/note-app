    ...
    <div>
        ...
        >
                            ...
                            <b-tabs card>
                                <b-tab v-for="(record, i) in form.contents" :key="'tab' + i" :title="record.filename">
                                    ...
                                    <b-form-group label="Kod">
                                        <div :id="`code-editor-edit-${i}`" class="code">{{ record.content  }}</div>
                                    </b-form-group>
                                </b-tab>
                                <template #tabs-end>
            ...
            <template v-slot:modal-footer>
                <b-button @click="save()" class="mr-1" variant="primary">Kaydet</b-button>
...
export default {
    ...
    methods: {
        ...
        onShow() {
            this.form = _.cloneDeep(this.selected);
            this.form.contents = _.map(this.form.contents, x => ({ filename: x.filename, content: x.content  }));
                ...
                this.$nextTick(
                    () => {
                        if (!this.form.contents[i].editor) {
                            this.form.contents[i].editor = ace.edit(`code-editor-edit-${i}`);
